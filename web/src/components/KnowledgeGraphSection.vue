<template>
  <div class="graph-section" v-if="isGraphSupported">
    <div class="graph-container-compact">
      ...
      <div v-else class="graph-wrapper" :class="{ 'graph-wrapper-3d': viewMode === '3d' }">
        <component
          :is="viewMode === '3d' ? GraphCanvas3D : GraphCanvas"
          ref="graphRef"
...
// rxyy-know 扩展：图谱 2D/3D 视图切换（3D 用 3d-force-graph 渲染，适合演示大图）
